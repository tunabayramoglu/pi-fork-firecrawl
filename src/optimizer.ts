...
export function selectCheapestTool(goal: string): {
	...
	if (lower.includes("all pages") || lower.includes("every page") || lower.includes("site map") || lower.includes("list all urls") || lower.includes("from a") || lower.includes("from this site") || lower.includes("selective") || lower.includes("specific pages") || (lower.includes("crawl") && lower.includes("docs")) || (lower.includes("crawl") && lower.includes("site")) || lower.includes("overview") || lower.includes("audit") || lower.includes("sitemap")) {
		return {
			tool: "firecrawl_map",
			params: {},
